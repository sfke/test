	...
	return this.each(
		function()
		{
			...
			if (percentInView < .99) {
				...
				$container.append(
					$('<div></div>').attr({'className':'jScrollPaneTrack'}).append(
						$('<div></div>').attr({'className':'jScrollPaneCont'}),
						$('<div></div>').attr({'className':'jScrollPaneDrag'}).append(
							$('<div></div>').attr({'className':'jScrollPaneDragTop'}),
							$('<div></div>').attr({'className':'jScrollPaneDragBottom'})
						)
					)
				);
