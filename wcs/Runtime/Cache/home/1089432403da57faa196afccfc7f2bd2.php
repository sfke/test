...
</script><?php  $route=explode("-",$arctype['route']); $result = count($route); $count = $m->table(C('DB_PREFIX').'arctype')->where('fid='.$route[1])->order('id asc')->count(); if($result == 1){?><div class="main_20 clearfix"></div><?php }else{?><div class="n_nav <?php if($count < 4): ?>n_nav2<?php endif; ?> clearfix"><?php  $variable244995['typeid'] = ($route[1]); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:0:"";s:3:"row";s:1:"1";s:4:"type";s:4:"self";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable244995)); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><h4 style="background: url(__BASE__/images/p<?php echo ($field['id']); ?>_tit.jpg) no-repeat center center;"><i><?php echo ($field['name']); ?></i></h4><?php } ?><p><?php  $variable625528['typeid'] = ($route[1]); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:0:"";s:3:"row";s:1:"8";s:4:"type";s:3:"son";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable625528)); foreach($arr as $index=>$field2){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><a href="<?php echo ($field2['url']); ?>" class="<?php if($index == 1 or $index == 4 or $index == 7){ echo lv ;}else if($index == 2 or $index == 5){ echo lan;}else{echo ju;} if($arctype['id'] == $field2['id']): ?>n_nav_on<?php endif; ?>"><img src="__BASE__/images/p<?php echo ($field2['fid']); ?>_<?php echo ($field2['id']); ?>.png" alt="" class="p4_img"><img src="__BASE__/images/p<?php echo ($field2['fid']); ?>_<?php echo ($field2['id']); ?>_h.png" alt="" class="p4_img_h"><i><?php echo ($field2['name']); ?></i></a><?php } ?></p></div><?php } ?><!-- 导航 --><div class="main main_fff clearfix"><div class="location clearfix">
		当前位置 : <?php echo ($position); ?></div><div class="list_p2_7 clearfix"><div class="p2_7_left"><img src="__BASE__/images/p2_p_bg.jpg" alt=""><img src="__BASE__/images/zz_y.png" alt="" class="zzy"><img src="__BASE__/images/bfb.png" alt="" class="bfb"></div><div class="p2_7_right"><img src="__BASE__/images/p2_p_bgtit.jpg" alt=""><?php echo ($arctype['txt']); ?></div><div class="p2_7_box"><?php echo ($arctype['txt2']); ?></div></div></div><footer class="clearfix2"><div class="footer wow fadeInUp clearfix"><div class="foot_left"><div id="outer"><div id="content"><div style="display:block;"><img src="__BASE__/images/ewm1.png" alt=""></div><div><img src="__BASE__/images/ewm1.png" alt=""></div><div><img src="__BASE__/images/ewm3.png" alt=""></div></div><ul id="tab"><li class="current"><img src="__BASE__/images/wb_icon.jpg" alt=""></li><li><img src="__BASE__/images/wx_icon.jpg" alt=""></li><li><img src="__BASE__/images/wap_icon.jpg" alt=""></li></ul></div></div><script>	$(function(){
