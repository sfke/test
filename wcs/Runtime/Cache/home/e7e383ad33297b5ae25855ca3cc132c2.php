...
</script><nav id="nav-wrap"><div id="menu-icon"><img src="__BASE__/wap/images/menu_bg.gif" width="40" height="33"></div><ul id="nav"><?php  $m = D("Arctype"); $arr = $m->getData('a:12:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:1:"6";s:3:"row";s:0:"";s:4:"type";s:3:"son";s:6:"typeid";s:2:"48";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}'); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><li><a href="<?php echo ($field['url']); ?>"><?php echo ($field['name']); ?></a></li><?php } ?></ul></nav></header><?php
 if($arctype['fid']==51){ ?><div class="twocolumns"><div class="swiper-wrapper"><?php  $variable579568['typeid'] = ($tid); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:1:"6";s:3:"row";s:0:"";s:4:"type";s:7:"brother";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable579568)); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><div class="swiper-slide <?php if($arctype['id'] == $field['id']): ?>on<?php endif; ?>"><a href="<?php echo ($field['url']); ?>"><?php echo ($field['name']); ?></a></div><?php } ?></div></div><script>
  var swiper = new Swiper('.twocolumns', {
    freeMode : true,
    slidesPerView : 'auto',
  });
</script><?php
 } ?><section class="ny_banner"><img src="__BASE__/wap/images/about_pic.jpg" width="720" height="319"></section><section class="ny_menu"><em><?php echo ($arctype['name']); ?></em><i></i></section><!--内页内容--><section class="ny_cont main"><div class="about"><?php
 if($_GET['tid']==53){ $typeid=7; }else if($_GET['tid']==55){ $typeid = 31; }else if($_GET['tid']==56){ $typeid = 32; }else if($_GET['tid']==57){ $typeid = 33; }else if($_GET['tid']==58){ $typeid = 34; }else if($_GET['tid']==59){ $typeid = 36; }else if($_GET['tid']==60){ $typeid = 35; } $model = M("addpage"); $where["typeid"] = array('eq' ,$typeid); $txt = $model->where($where)->getField("txt"); echo ($txt); ?></div></section><footer><ul><li><a href="<?php echo U('Wap/index');?>"><i class="icon iconfont">&#xe673;</i><span>网站首页</span></a></li><li><a href="<?php echo listUrl(49);?>"><i class="icon iconfont">&#xe671;</i><span>关于华奥</span></a></li><li><a href="<?php echo listUrl(51);?>"><i class="icon iconfont">&#xe601;</i><span>业务产品</span></a></li><li><a href="<?php echo listUrl(53);?>"><i class="icon iconfont">&#xe69c;</i><span>联系我们</span></a></li></ul></footer></body></html>