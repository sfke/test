...
</script><?php  $route=explode("-",$arctype['route']); $result = count($route); $count = $m->table(C('DB_PREFIX').'arctype')->where('fid='.$route[1])->order('id asc')->count(); if($result == 1){?><div class="main_20 clearfix"></div><?php }else{?><div class="n_nav <?php if($count < 4): ?>n_nav2<?php endif; ?> clearfix"><?php  $variable245217['typeid'] = ($route[1]); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:0:"";s:3:"row";s:1:"1";s:4:"type";s:4:"self";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable245217)); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><h4 style="background: url(__BASE__/images/p<?php echo ($field['id']); ?>_tit.jpg) no-repeat center center;"><i><?php echo ($field['name']); ?></i></h4><?php } ?><p><?php  $variable019788['typeid'] = ($route[1]); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:0:"";s:3:"row";s:1:"8";s:4:"type";s:3:"son";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable019788)); foreach($arr as $index=>$field2){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><a href="<?php echo ($field2['url']); ?>" class="<?php if($index == 1 or $index == 4 or $index == 7){ echo lv ;}else if($index == 2 or $index == 5){ echo lan;}else{echo ju;} if($arctype['id'] == $field2['id']): ?>n_nav_on<?php endif; ?>"><img src="__BASE__/images/p<?php echo ($field2['fid']); ?>_<?php echo ($field2['id']); ?>.png" alt="" class="p4_img"><img src="__BASE__/images/p<?php echo ($field2['fid']); ?>_<?php echo ($field2['id']); ?>_h.png" alt="" class="p4_img_h"><i><?php echo ($field2['name']); ?></i></a><?php } ?></p></div><?php } ?><!-- 导航 --><div class="main main_fff clearfix"><div class="location clearfix">
		当前位置 : <?php echo ($position); ?></div><div id="demo1" class="picBtnTop clearfix"><div class="bd"><ul><?php  $variable531162['typeid'] = ($tid); $m = D("Archives"); $arr = $m->getData('a:15:{s:7:"desclen";s:3:"180";s:8:"titlelen";s:2:"36";s:8:"addfield";s:2:"on";s:5:"color";s:3:"off";s:3:"row";s:1:"3";s:4:"flag";s:1:"c";s:5:"class";s:0:"";s:7:"orderby";s:2:"id";s:8:"orderway";s:4:"desc";s:5:"title";s:0:"";s:9:"channelid";s:0:"";s:5:"limit";s:0:"";s:9:"pagebreak";s:3:"off";s:5:"where";s:0:"";s:6:"result";s:0:"";}',serialize($variable531162)); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><li><a href="<?php echo ($field['url']); ?>"><img src="<?php echo (($field['img'])?($field['img']):$defaultimg); ?>" /></a></li><?php } ?></ul></div><div class="hd"><ul><?php  $variable848619['typeid'] = ($tid); $m = D("Archives"); $arr = $m->getData('a:15:{s:7:"desclen";s:3:"180";s:8:"titlelen";s:2:"36";s:8:"addfield";s:2:"on";s:5:"color";s:3:"off";s:3:"row";s:1:"3";s:4:"flag";s:1:"c";s:5:"class";s:0:"";s:7:"orderby";s:2:"id";s:8:"orderway";s:4:"desc";s:5:"title";s:0:"";s:9:"channelid";s:0:"";s:5:"limit";s:0:"";s:9:"pagebreak";s:3:"off";s:5:"where";s:0:"";s:6:"result";s:0:"";}',serialize($variable848619)); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><li><h5><a href="<?php echo ($field['url']); ?>"><?php echo ($field['title']); ?></a><span><?php echo jldate($field['pubdate']);?></span></h5><p><?php echo ($field['desc']); ?></p></li><?php } ?></ul></div></div><!-- 新闻头条 --><script type="text/javascript">
	jQuery("#demo1").slide({ mainCell:".bd ul",effect:"top",autoPlay:true,triggerTime:0 });</script><div class="news_p3_1 clearfix"><?php  $m = D("Archives"); $arr = $m->getPageList('a:12:{s:8:"addfield";s:2:"on";s:7:"desclen";s:3:"180";s:5:"color";s:3:"off";s:8:"titlelen";s:2:"36";s:6:"typeid";N;s:5:"class";s:0:"";s:4:"flag";s:0:"";s:7:"orderby";s:2:"id";s:8:"orderway";s:4:"desc";s:8:"pagesize";s:2:"10";s:5:"where";s:0:"";s:6:"result";s:0:"";}'); $pageline = $arr["pageline"]; $pageinfo = $arr["pageinfo"]; unset($arr["pageline"],$arr["pageinfo"]); foreach($arr as $index=> $field){ ?><dl><dt><a href="<?php echo ($field['url']); ?>"><img src="<?php echo (($field['img'])?($field['img']):$defaultimg); ?>" alt=""></a></dt><dd><h5><a href="<?php echo ($field['url']); ?>"><?php echo ($field['title']); ?></a><span><?php echo jldate($field['pubdate']);?></span></h5><p><?php echo ($field['desc']); ?></p><a href="<?php echo ($field['url']); ?>">了解更多</a></dd></dl><?php } ?></div><div class="page clearfix"><?php echo ($pageline); ?></div></div><footer class="clearfix2"><div class="footer wow fadeInUp clearfix"><div class="foot_left"><div id="outer"><div id="content"><div style="display:block;"><img src="__BASE__/images/ewm1.png" alt=""></div><div><img src="__BASE__/images/ewm1.png" alt=""></div><div><img src="__BASE__/images/ewm3.png" alt=""></div></div><ul id="tab"><li class="current"><img src="__BASE__/images/wb_icon.jpg" alt=""></li><li><img src="__BASE__/images/wx_icon.jpg" alt=""></li><li><img src="__BASE__/images/wap_icon.jpg" alt=""></li></ul></div></div><script>	$(function(){
