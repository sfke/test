...
</script><?php  $route=explode("-",$arctype['route']); $result = count($route); $count = $m->table(C('DB_PREFIX').'arctype')->where('fid='.$route[1])->order('id asc')->count(); if($result == 1){?><div class="main_20 clearfix"></div><?php }else{?><div class="n_nav <?php if($count < 4): ?>n_nav2<?php endif; ?> clearfix"><?php  $variable967524['typeid'] = ($route[1]); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:0:"";s:3:"row";s:1:"1";s:4:"type";s:4:"self";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable967524)); foreach($arr as $index=>$field){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><h4 style="background: url(__BASE__/images/p<?php echo ($field['id']); ?>_tit.jpg) no-repeat center center;"><i><?php echo ($field['name']); ?></i></h4><?php } ?><p><?php  $variable976484['typeid'] = ($route[1]); $m = D("Arctype"); $arr = $m->getData('a:11:{s:8:"addfield";s:3:"off";s:8:"isparent";s:0:"";s:8:"titlelen";s:0:"";s:3:"row";s:1:"8";s:4:"type";s:3:"son";s:7:"orderby";s:5:"order";s:8:"orderway";s:3:"asc";s:5:"limit";s:0:"";s:5:"class";s:0:"";s:6:"result";s:0:"";s:5:"where";s:0:"";}',serialize($variable976484)); foreach($arr as $index=>$field2){ if($index == 0 ) $isfirst = true;else $isfirst = false; if($index == count($arr)-1 ) $islast = true;else $islast = false; ?><a href="<?php echo ($field2['url']); ?>" class="<?php if($index == 1 or $index == 4 or $index == 7){ echo lv ;}else if($index == 2 or $index == 5){ echo lan;}else{echo ju;} if($arctype['id'] == $field2['id']): ?>n_nav_on<?php endif; ?>"><img src="__BASE__/images/p<?php echo ($field2['fid']); ?>_<?php echo ($field2['id']); ?>.png" alt="" class="p4_img"><img src="__BASE__/images/p<?php echo ($field2['fid']); ?>_<?php echo ($field2['id']); ?>_h.png" alt="" class="p4_img_h"><i><?php echo ($field2['name']); ?></i></a><?php } ?></p></div><?php } ?><!-- 导航 --><div class="main main_fff clearfix"><div class="location clearfix">
		当前位置 ><?php echo ($position); ?></div><ul class="p3_3 clearfix"><?php  $m = D("Archives"); $arr = $m->getPageList('a:12:{s:8:"addfield";s:2:"on";s:7:"desclen";s:0:"";s:5:"color";s:3:"off";s:8:"titlelen";s:2:"12";s:6:"typeid";N;s:5:"class";s:0:"";s:4:"flag";s:0:"";s:7:"orderby";s:2:"id";s:8:"orderway";s:4:"desc";s:8:"pagesize";s:1:"9";s:5:"where";s:0:"";s:6:"result";s:0:"";}'); $pageline = $arr["pageline"]; $pageinfo = $arr["pageinfo"]; unset($arr["pageline"],$arr["pageinfo"]); foreach($arr as $index=> $field){ ?><li><a href="<?php echo ($field['url']); ?>"><img src="<?php echo (($field['img'])?($field['img']):$defaultimg); ?>" alt=""><i><img src="__BASE__/images/p33_hover.png" alt=""></i><span><?php echo ($field['title']); ?></span></a></li><?php } ?></ul><div class="page clearfix"><?php echo ($pageline); ?></div><script>
		$(document).ready(function(event){
			$('.p3_3 li:nth-child(1),.p3_3 li:nth-child(2),.p3_3 li:nth-child(3)').css({
				marginTop: '0'
			});
		    $('.p3_3 li a').hover(function() {
		    	$(this).find('i').slideUp(500);
		    	$(this).find('span').stop().animate({bottom:'0'});
		    }, function() {
		    	$(this).find('i').slideDown(500);
		    	$(this).find('span').stop().animate({bottom:'-50px'})
		    });
		  
		})

	</script></div><footer class="clearfix2"><div class="footer wow fadeInUp clearfix"><div class="foot_left"><div id="outer"><div id="content"><div style="display:block;"><img src="__BASE__/images/ewm1.png" alt=""></div><div><img src="__BASE__/images/ewm1.png" alt=""></div><div><img src="__BASE__/images/ewm3.png" alt=""></div></div><ul id="tab"><li class="current"><img src="__BASE__/images/wb_icon.jpg" alt=""></li><li><img src="__BASE__/images/wx_icon.jpg" alt=""></li><li><img src="__BASE__/images/wap_icon.jpg" alt=""></li></ul></div></div><script>	$(function(){
