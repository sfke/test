 ...
 *  @package    Controls
 */
class Zebra_Form_Color extends Zebra_Form_Control
{
     ...
     *  @return void
     */
    function Zebra_Form_Color($id, $default = '', $attributes = '')
    {
    ...
    {   $name = $this->attributes['name'];
        ...
        return $source.'<input ' . $this->_render_attributes() . ($this->form_properties['doctype'] == 'xhtml' ? '/' : '') . '>';
