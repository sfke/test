    ...
    public function fetch($templateFile='',$content='',$prefix='') {
        if(empty($content)) {
            ...
            if(!is_file($templateFile)){
                ...
                $count = count($templateFileArr);
                if(!empty($templateFileArr) && !empty($templateFileArr[$count-1]) ){
                    $templateFileArr[$count-1] = strtolower($templateFileArr[$count-1]);
                    $templateFileArr[$count-2] = strtolower($templateFileArr[$count-2]);
                    $newfilename = implode("/", $templateFileArr);
                }
